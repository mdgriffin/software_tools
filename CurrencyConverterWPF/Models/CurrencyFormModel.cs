...
{
    public class CurrencyFormModel: BaseModel, INotifyDataErrorInfo
    {
        ...
        public CurrencyFormModel(String fromCode, String from, String toCode, String to)
        {
